...
test('generates the complete Arabic and English prerendered route set', () => {
  // 58 bilingual routes — blog listing/articles are SSR and not written to dist/client
  assert.equal(expectedStatic.length, 58);
  assert.equal(expectedRoutes().length, 65);
