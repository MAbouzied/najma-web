...
/**
 * Mock Arabic blog fixtures for Nagm Spa launch.
...
export const mockBlogPosts: BlogPost[] = [
  {
    ...
    cover: {
      src: '/assets/home/services/swedish-massage.jpg',
    ...
    draft: false,
    seo: {
      title: 'دليل أنواع المساج في حفر الباطن | نجم سبا',
      description:
        'تعرّف على أنواع المساج في نجم سبا بحفر الباطن، والفروقات بينها، وكيف تختار الجلسة المناسبة لاحتياجك.',
    },
    ...
    body: {
      ...
      blocks: [
        ...
        },
        {
          type: 'image',
          image: {
            src: '/assets/home/services/hot-stone.jpg',
        ...
        },
        {
          ...
          label: 'فيديو قصير عن أجواء الجلسة داخل نجم سبا (قريباً)',
  ...
  },
  {
    ...
    cover: {
      src: '/assets/home/services/moroccan-bath.jpg',
    ...
    draft: false,
    seo: {
      title: 'الحمام المغربي في حفر الباطن | نجم سبا',
      description:
        'تعرّف على خطوات الحمام المغربي في نجم سبا بحفر الباطن وما ينبغي معرفته قبل الحجز وبعد الجلسة.',
    },
    ...
    body: {
      ...
      blocks: [
        ...
        },
        {
          ...
          parts: [
            { text: 'اطّلع على ' },
            { text: 'خدمة الحمام المغربي', href: '/services/moroccan-bath/' },
            { text: ' أو ' },
  ...
  },
  {
    ...
    cover: {
      src: '/assets/home/services/aromatherapy.jpg',
    ...
    seo: {
      description:
        'تعرّف على فوائد مساج الاسترخاء وكيف تجهّز نفسك لجلسة مريحة في نجم سبا بحفر الباطن.',
    },
    relatedSlugs: ['dalil-anwaa-almasaj-hafr-albatin', 'inah-baad-aljalsa'],
    body: {
      format: 'blocks',
      blocks: [
        ...
        },
        {
          ...
          parts: [
            { text: 'ابدأ من ' },
            { text: 'مساج الاسترخاء', href: '/services/massage-relaxation/' },
            { text: ' أو ' },
  ...
  },
  {
    ...
    cover: {
      src: '/assets/home/services/deep-tissue.jpg',
  ...
  },
  {
    ...
    cover: {
      src: '/assets/home/services/facial-care.jpg',
    ...
    draft: false,
    seo: {
      title: 'العناية بعد جلسة السبا | مدونة نجم سبا',
      description:
        'نصائح عملية بعد جلسة المساج أو الحمام المغربي في نجم سبا بحفر الباطن.',
    },
  ...
  {
    id: 'post-first-visit',
    slug: 'awwal-ziyara-li-nagm-spa',
    locale: 'ar',
    title: 'أول زيارة لنجم سبا: ماذا تحضّر قبل الموعد؟',
    excerpt:
    ...
    cover: {
      src: '/assets/home/hero-interior.jpg',
      alt: 'أجواء داخلية هادئة في نجم سبا',
      width: 1600,
      height: 1067,
    },
    ...
    seo: {
      description:
        'نصائح لأول زيارة إلى نجم سبا في حفر الباطن: كيف تحجز، ماذا تتوقع، وكيف تختار خدمتك الأولى.',
    },
    relatedSlugs: ['dalil-anwaa-almasaj-hafr-albatin', 'inah-baad-aljalsa'],
    body: {
      format: 'blocks',
